...
class ListingController extends Controller
{
    public function index(Request $request)
    {
        ...
        $listings = $query->paginate(9); // Consistent pagination
        return view('listings.index', compact('listings'));
    }

    public function create()
    {
        $listings = Listing::select('title', 'image_url')->latest()->take(6)->get();
        return view('listings.create', compact('listings'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'hotel_category' => 'required|in:Luxury,Boutique,Budget,Hostel,Resort',
    ...
    public function edit($id)
    {
        ...
        $listings = Listing::take(6)->get();
        return view('listings.edit', compact('listing', 'listings'));
    }
    ...
    public function search(Request $request)
{
    ...
    return view('listings.index', compact('listings', 'location_city', 'start_date', 'end_date', 'number_of_travelers'));
}
}