                    ...
                    <div class="col-md-6">
                        ...
                        <form method="POST" action="{{ route('listings.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control bg-transparent" name="price_per_night" id="price_per_night" placeholder="Price per Night" required>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-outline-light w-100 py-3">Add Hotel</button>
                                </div>
                            </div>
                        </form>
                    </div>
