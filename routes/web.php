...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/listings/create-step1', [ListingController::class, 'createStep1'])->name('listings.create-step1');
...
Route::get('/listings/create-step3/{id}', [ListingController::class, 'createStep3'])->name('listings.create-step3');
Route::post('/listings/store-step3/{id}', [ListingController::class, 'storeStep3'])->name('listings.store-step3');
